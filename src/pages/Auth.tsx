      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10">
        <div className="w-full max-w-sm glass-card p-8 rounded-[2.5rem] shadow-2xl shadow-primary/5">
          ...
          <div className="text-center mb-8">
            <div className="w-24 h-24 md:w-32 md:h-32 flex items-center justify-center mx-auto mb-6 animate-float">
              <img src="/logo.png" alt="VOY Logo" className="w-full h-full object-contain drop-shadow-2xl brightness-110" />
            </div>
            <p className="text-xl md:text-2xl font-black text-primary tracking-tighter uppercase mb-1">
              VOY App
            </p>
              ...
              {!isLogin && !isForgotPassword && (
                <div className="flex items-start space-x-3 p-2">
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    >
                      Eu aceito os Termos de Uso e a Política de Privacidade (LGPD/GDPR) do VOY App.
                    </label>
                    <div className="flex gap-2 text-[10px] uppercase font-black tracking-widest text-primary/60">
                      <button type="button" onClick={() => navigate('/terms')} className="hover:text-primary transition-colors">Termos de Uso</button>
                      <span>•</span>
                      <button type="button" onClick={() => navigate('/terms')} className="hover:text-primary transition-colors">Privacidade</button>
                    </div>
                  </div>
                </div>
              )}
